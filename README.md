...
Email Marketing Automation is an open-core email marketing automation tool. 


## Features
![Image of Email Marketing Automation](./docs/.gitbook/assets/my-movie-4%20(1).gif)
...
- **Automation runs** for lead enrollment + timed multi-step email delivery (`/automation/*` HTTP routes)

## Quick Start

Set up Email Marketing Automation with **Docker Compose**:
...
[Read about importing data to begin using the platform.](https://sequence.gitbook.io/sequence/node-sdk/node-sdk)

[Read our Documentation here.](https://sequence.gitbook.io/sequence/node-sdk/node-sdk)
## Building Email Marketing Automation
...
```text
git clone https://github.com/Ravikant-1811/Email-Marketing-Automation.git
...
Email Marketing Automation is an open core email marketing automation tool. It allows you to send a one-off email to a list of people. 

### The Vision

Email Marketing Automation will be the bridge between data teams and data-driven marketers, allowing marketers to unlock the full potential of their customer data. 
...
Open an issue in this repository if any errors occur.
